<?php
  ...
  if ($order == 0){
    echo("This page requires an order id <br>");
    exit();
  }
    ...
    if ( !$res ) {
      ...
      if(mysqli_num_rows($res)< 1){
        ...
        while ( $row = mysqli_fetch_array($res) ) {
         ...
         echo("</td>"
              ."<td><a href='order_items.add.php?stock=".$row['Stock_id']."&order=".$order."'>Add to order</a></td></tr>"); 
              
        }

       echo "<tr><td colspan='7'><center><a href='orders.details.php?id=".$order."'>Back to Order</a></td></tr>";
        echo "</table>"; 
      } 
